...
const SimulationsPage: React.FC<SimulationsPageProps> = ({ className }) => {
  return (
    <div className={cn('max-w-[1200px] mx-auto', className)}>
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Simulations</h1>
        <p className="text-sm text-gray-500 mt-2">Practice with voice simulations</p>
      </div>
      ...
      <div className="flex items-center justify-center py-20 bg-white border border-gray-200 rounded-2xl">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Voice Simulations</h2>
          <p className="text-gray-500">Simulation sessions will be displayed here</p>
        </div>
      </div>
    </div>
  );
