  ...
  return (
    <div className={cn('max-w-[1200px] mx-auto', className)}>
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-2">AI-powered assistance during live calls</p>
      </div>
      ...
      <div className="flex items-center justify-center py-20 bg-white border border-gray-200 rounded-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-500">Real-time assistance will be displayed here</p>
        </div>
      </div>
    </div>
  );
