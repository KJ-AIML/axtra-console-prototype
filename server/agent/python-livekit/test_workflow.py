...
user_info_data = {
    ...
    "contact": {"phone": "+1 (555) 234-5678", "email": "sarah.thompson@email.com"},
    "subscription": {
        "plan": "Premium Plus",
    ...
    "stats": {"total_calls": 23, "csat_score": 4.2},
    "call_history": [
        {
            "date": "2024-01-28",
            "status": "Resolved",
